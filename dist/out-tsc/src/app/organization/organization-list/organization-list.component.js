...
var OrganizationListComponent = /** @class */ (function () {
    function OrganizationListComponent(api, router, route, alerts) {
        this.api = api;
        this.router = router;
        this.route = route;
        this.alerts = alerts;
        this.displayedColumns = ['title', 'description'];
        this.dataSource = new OrganizationDataSource(this.api);
    }
...
var OrganizationDataSource = /** @class */ (function (_super) {
    __extends(OrganizationDataSource, _super);
    function OrganizationDataSource(api) {
        var _this = _super.call(this) || this;
        _this.api = api;
        return _this;
    }
    OrganizationDataSource.prototype.connect = function () {
        return this.api.getOrganizations();
    };
    OrganizationDataSource.prototype.disconnect = function () {
    };
